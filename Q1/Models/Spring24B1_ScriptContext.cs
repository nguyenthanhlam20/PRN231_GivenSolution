...
namespace Q1.Models
{
    public partial class Spring24B1_ScriptContext : DbContext
    {
        public Spring24B1_ScriptContext()
        {
        }

        public Spring24B1_ScriptContext(DbContextOptions<Spring24B1_ScriptContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeProject>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.ProjectId })
                    .HasName("PK__Employee__6DB1E41CB54D26A8");
            ...
            modelBuilder.Entity<EmployeeSkill>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.SkillId })
                    .HasName("PK__Employee__172A46EFB5B9B116");
